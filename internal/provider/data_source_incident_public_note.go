...
var _ datasource.DataSource = &IncidentPublicNoteDataSource{}

func NewIncidentPublicNoteDataSource() datasource.DataSource {
    return &IncidentPublicNoteDataSource{}
}

// IncidentPublicNoteDataSource defines the data source implementation.
type IncidentPublicNoteDataSource struct {
    client *Client
}
...
func (d *IncidentPublicNoteDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *IncidentPublicNoteDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *IncidentPublicNoteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
    var data IncidentPublicNoteDataSourceModel
    ...
    if hasId {
        readPath := "/incident-public-note/" + data.Id.ValueString() + "/get-item"
        ...
        if err := d.client.ParseResponse(httpResp, &itemResponse); err != nil {
            resp.Diagnostics.AddError("OneUptime API Error", fmt.Sprintf("Unable to read incident_public_note: %s", err))
            return
        }
        ...
        if err := d.client.ParseResponse(httpResp, &listResponse); err != nil {
            resp.Diagnostics.AddError("OneUptime API Error", fmt.Sprintf("Unable to list incident_public_note: %s", err))
            return
        }
        ...
        if !ok {
            resp.Diagnostics.AddError("OneUptime API Error", "Unexpected list response shape for incident_public_note.")
            return
        }
        item = first
    }
