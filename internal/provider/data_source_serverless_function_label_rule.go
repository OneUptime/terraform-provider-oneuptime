...
var _ datasource.DataSource = &ServerlessFunctionLabelRuleDataSource{}

func NewServerlessFunctionLabelRuleDataSource() datasource.DataSource {
    return &ServerlessFunctionLabelRuleDataSource{}
}

// ServerlessFunctionLabelRuleDataSource defines the data source implementation.
type ServerlessFunctionLabelRuleDataSource struct {
    client *Client
}
...
func (d *ServerlessFunctionLabelRuleDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *ServerlessFunctionLabelRuleDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ServerlessFunctionLabelRuleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
    var data ServerlessFunctionLabelRuleDataSourceModel
    ...
    if hasId {
        readPath := "/serverless-function-label-rule/" + data.Id.ValueString() + "/get-item"
        ...
        if err := d.client.ParseResponse(httpResp, &itemResponse); err != nil {
            resp.Diagnostics.AddError("OneUptime API Error", fmt.Sprintf("Unable to read serverless_function_label_rule: %s", err))
            return
        }
        ...
        if err := d.client.ParseResponse(httpResp, &listResponse); err != nil {
            resp.Diagnostics.AddError("OneUptime API Error", fmt.Sprintf("Unable to list serverless_function_label_rule: %s", err))
            return
        }
        ...
        if !ok {
            resp.Diagnostics.AddError("OneUptime API Error", "Unexpected list response shape for serverless_function_label_rule.")
            return
        }
        item = first
    }
