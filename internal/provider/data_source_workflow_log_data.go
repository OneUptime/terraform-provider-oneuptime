    ...
    resp.Schema = schema.Schema{
        ...
        Attributes: map[string]schema.Attribute{
            ...
            "logs": schema.StringAttribute{
                MarkdownDescription: "Logs. Permissions - Create: [No access - you don't have permission for this operation], Read: [Project Owner, Project Admin, Project Member, Read Workflow Log, Read All Project Resources], Update: [No access - you don't have permission for this operation]",
                Computed: true,
            },
            "workflow_status": schema.StringAttribute{
                MarkdownDescription: "Status of this workflow. Permissions - Create: [No access - you don't have permission for this operation], Read: [Project Owner, Project Admin, Project Member, Read Workflow Log, Read All Project Resources], Update: [No access - you don't have permission for this operation]",
                Computed: true,
            },
