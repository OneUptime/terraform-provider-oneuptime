...
func (d *NetworkSiteTypeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
    resp.Schema = schema.Schema{
        MarkdownDescription: "Configure the levels of your network site hierarchy (Region, Market, Unit and so on). Rename them, reorder them, or add your own. Look up an existing network_site_type by `id` or by `name`.",
        ...
        Attributes: map[string]schema.Attribute{
            ...
            "order": schema.NumberAttribute{
                MarkdownDescription: "Where this type sits in the site hierarchy. Lower numbers are higher up: Region is 2 and Unit is 5, for example..",
                Computed: true,
            },
