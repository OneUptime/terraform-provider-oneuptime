---
page_title: "oneuptime_on_call_schedule_user_owner Resource - oneuptime"
subcategory: "On-Call & Escalation"
description: |-
  Add users as owners to your on-call schedules.
---

# oneuptime_on_call_schedule_user_owner (Resource)
...
```terraform
resource "oneuptime_on_call_schedule_user_owner" "example" {
...
```shell
terraform import oneuptime_on_call_schedule_user_owner.example <id>
```
