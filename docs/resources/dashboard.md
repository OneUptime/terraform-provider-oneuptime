...
- `dashboard_view_config` (String) Configuration of Dashboard View. Permissions - Create: [Project Owner, Project Admin, Create Dashboard], Read: [Project Owner, Project Admin, Project Member, Viewer, Settings Admin, Settings Member, Settings Viewer, Read Dashboard, Read All Project Resources], Update: [Project Owner, Project Admin, Edit Dashboard]. Computed.
...
- `is_public_dashboard` (Bool) Is this dashboard public?. Permissions - Create: [Project Owner, Project Admin, Create Dashboard], Read: [Project Owner, Project Admin, Project Member, Viewer, Settings Admin, Settings Member, Settings Viewer, Read Dashboard, Read All Project Resources], Update: [Project Owner, Project Admin, Edit Dashboard]. Computed.
