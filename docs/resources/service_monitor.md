...
page_title: "oneuptime_service_monitor Resource - oneuptime"
subcategory: ""
description: |-
  Service monitor resource
---

# oneuptime_service_monitor (Resource)
...
```terraform
resource "oneuptime_service_monitor" "example" {
...
```shell
terraform import oneuptime_service_monitor.example <id>
```
