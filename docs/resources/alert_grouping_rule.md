...
- `name` (String) Name of this alert grouping rule. Permissions - Create: [Project Owner, Project Admin, Create Alert Grouping Rule], Read: [Project Owner, Project Admin, Project Member, Read Alert Grouping Rule, Read All Project Resources], Update: [Project Owner, Project Admin, Edit Alert Grouping Rule]. Required.
...
- `is_enabled` (Bool) Whether this rule is enabled. Permissions - Create: [Project Owner, Project Admin, Create Alert Grouping Rule], Read: [Project Owner, Project Admin, Project Member, Read Alert Grouping Rule, Read All Project Resources], Update: [Project Owner, Project Admin, Edit Alert Grouping Rule]. Computed.
