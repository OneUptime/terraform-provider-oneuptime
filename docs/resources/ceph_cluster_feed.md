...
```terraform
resource "oneuptime_ceph_cluster_feed" "example" {
  ceph_cluster_id = "123e4567-e89b-12d3-a456-426614174000"
  feed_info_in_markdown = "# Heading

This is **markdown** content"
  ceph_cluster_feed_event_type = "Example short text"
...
```shell
terraform import oneuptime_ceph_cluster_feed.example <id>
```
