...
- `key` (String) Permissions - Create: [Project Owner, Project Admin, Project Member, Settings Manager, Create AI Agent], Read: [Project Owner, Project Admin, Read All Project Resources], Update: [Project Owner, Project Admin, Project Member, Settings Manager, Edit AI Agent]. Required.
