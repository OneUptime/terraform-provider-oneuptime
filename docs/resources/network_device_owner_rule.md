...
- `name` (String) Name of this network device owner rule..
...
- `network_device_labels` (Set) Only trigger for network devices that have at least one of these labels. Leave empty to match regardless of labels...
...
- `owner_users` (Set) Users to add as owners on the network device when this rule matches...
- `owner_teams` (Set) Teams to add as owners on the network device when this rule matches...
