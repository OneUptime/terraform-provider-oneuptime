...
- `match_labels` (Set) Only trigger for applications that have at least one of these labels. Leave empty to match regardless of labels...
...
- `owner_users` (Set) Users to add as owners on the application when this rule matches...
- `owner_teams` (Set) Teams to add as owners on the application when this rule matches...
