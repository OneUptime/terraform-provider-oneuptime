---
page_title: "oneuptime_io_t_fleet_user_owner Resource - oneuptime"
subcategory: "Other"
description: |-
  Add users as owners to your IoT fleets.
---

# oneuptime_io_t_fleet_user_owner (Resource)
...
```terraform
resource "oneuptime_io_t_fleet_user_owner" "example" {
...
```shell
terraform import oneuptime_io_t_fleet_user_owner.example <id>
```
