...
- `include_non_alerting_detections` (Bool) Include detections that have not been marked as alerts in Google SecOps...
...
- `cursor` (String) Poll cursor: the end of the last completely processed window, or the boundary retained for retry, as an ISO string...
