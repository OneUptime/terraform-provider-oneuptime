...
- `dashboard_labels` (Set) Only trigger for dashboards that have at least one of these labels. Leave empty to match regardless of labels...
...
- `owner_users` (Set) Users to add as owners on the dashboard when this rule matches...
- `owner_teams` (Set) Teams to add as owners on the dashboard when this rule matches...
