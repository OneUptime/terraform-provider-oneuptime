...
- `header_html` (String) Status Page Custom HTML Header..
- `footer_html` (String) Status Page Custom HTML Footer..
- `custom_css` (String) Status Page Custom CSS Header..
- `custom_java_script` (String) Status Page Custom JavaScript. This runs when the status page is loaded...
