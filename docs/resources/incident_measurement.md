...
- `name` (String) Human readable name of this measurement. This is what appears on charts and on the incident page...
...
- `start_incident_state_id` (String) A unique identifier for an object, represented as a UUID..
- `end_incident_state_id` (String) A unique identifier for an object, represented as a UUID..
...
- `aggregation_type` (String) The aggregation this measurement's charts default to - Avg, Max, Min, P50, P90, P95 or P99. Sum is deliberately absent because summing durations across incidents produces a number with no meaning...
