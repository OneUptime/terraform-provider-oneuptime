...
- `name` (String) Any friendly name of this object. Permissions - Create: [Project Owner, Project Admin, Create Team], Read: [Project Owner, Project Admin, Project Member, Viewer, Settings Admin, Settings Member, Settings Viewer, Read Teams, Read All Project Resources], Update: [Project Owner, Project Admin, Edit Team]. Required.
- `description` (String) Friendly description that will help you remember. Permissions - Create: [Project Owner, Project Admin, Create Team], Read: [Project Owner, Project Admin, Project Member, Viewer, Settings Admin, Settings Member, Settings Viewer, Read Teams, Read All Project Resources], Update: [Project Owner, Project Admin, Edit Team]. Computed.
