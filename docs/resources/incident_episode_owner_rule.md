...
- `name` (String) Name of this incident episode owner rule..

### Optional

- `project_id` (String) A unique identifier for an object, represented as a UUID..
- `description` (String) Description of this incident episode owner rule..
...
- `owner_users` (Set) Users to add as owners on the incident episode when this rule matches...
- `owner_teams` (Set) Teams to add as owners on the incident episode when this rule matches...
