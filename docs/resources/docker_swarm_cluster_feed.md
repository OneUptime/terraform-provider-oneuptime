...
```terraform
resource "oneuptime_docker_swarm_cluster_feed" "example" {
  docker_swarm_cluster_id = "123e4567-e89b-12d3-a456-426614174000"
  feed_info_in_markdown = "# Heading

This is **markdown** content"
  docker_swarm_cluster_feed_event_type = "Example short text"
...
- `docker_swarm_cluster_id` (String) A unique identifier for an object, represented as a UUID..
...
```shell
terraform import oneuptime_docker_swarm_cluster_feed.example <id>
```
