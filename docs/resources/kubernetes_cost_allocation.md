...
page_title: "oneuptime_kubernetes_cost_allocation Resource - oneuptime"
subcategory: ""
description: |-
  Kubernetes cost allocation resource
---

# oneuptime_kubernetes_cost_allocation (Resource)
...
```terraform
resource "oneuptime_kubernetes_cost_allocation" "example" {
...
```shell
terraform import oneuptime_kubernetes_cost_allocation.example <id>
```
