---
page_title: "oneuptime_incident_episode_internal_note Resource - oneuptime"
subcategory: "Incidents"
description: |-
  Manage internal notes for your incident episodes
---

# oneuptime_incident_episode_internal_note (Resource)
...
```terraform
resource "oneuptime_incident_episode_internal_note" "example" {
...
```shell
terraform import oneuptime_incident_episode_internal_note.example <id>
```
