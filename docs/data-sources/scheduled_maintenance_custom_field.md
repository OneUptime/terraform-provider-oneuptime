---
page_title: "oneuptime_scheduled_maintenance_custom_field Data Source - oneuptime"
subcategory: "Scheduled Maintenance"
description: |-
  Manage custom fields for your scheduled event
---

# oneuptime_scheduled_maintenance_custom_field (Data Source)

Manage custom fields for your scheduled event Look up by `id` or by `name` (must match exactly one item).
...
```terraform
data "oneuptime_scheduled_maintenance_custom_field" "by_name" {
  name = "example-scheduled_maintenance_custom_field"
}

data "oneuptime_scheduled_maintenance_custom_field" "by_id" {
