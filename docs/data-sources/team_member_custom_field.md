---
page_title: "oneuptime_team_member_custom_field Data Source - oneuptime"
subcategory: "Teams & Access"
description: |-
  Manage custom fields for your team members.
---

# oneuptime_team_member_custom_field (Data Source)

Manage custom fields for your team members. Look up by `id` or by `name` (must match exactly one item).
...
```terraform
data "oneuptime_team_member_custom_field" "by_name" {
  name = "example-team_member_custom_field"
}

data "oneuptime_team_member_custom_field" "by_id" {
