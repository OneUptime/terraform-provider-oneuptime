---
page_title: "oneuptime_team_on_call_duty_escalation_rule Data Source - oneuptime"
subcategory: "Teams & Access"
description: |-
  Manage on-call duty escalation rule for the on-call policy.
---

# oneuptime_team_on_call_duty_escalation_rule (Data Source)
...
```terraform
data "oneuptime_team_on_call_duty_escalation_rule" "by_name" {
  name = "example-team_on_call_duty_escalation_rule"
}

data "oneuptime_team_on_call_duty_escalation_rule" "by_id" {
