...
page_title: "oneuptime_host_team_owner_data Data Source - oneuptime"
subcategory: ""
description: |-
  Host team owner data data source
---

# oneuptime_host_team_owner_data (Data Source)
...
```terraform
data "oneuptime_host_team_owner_data" "example" {
  name = "example-host_team_owner_data"
}
```
