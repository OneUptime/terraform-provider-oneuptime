...
page_title: "oneuptime_network_device_team_owner_data Data Source - oneuptime"
subcategory: ""
description: |-
  Network device team owner data data source
---

# oneuptime_network_device_team_owner_data (Data Source)
...
```terraform
data "oneuptime_network_device_team_owner_data" "example" {
  name = "example-network_device_team_owner_data"
}
```
