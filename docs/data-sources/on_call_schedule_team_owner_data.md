...
page_title: "oneuptime_on_call_schedule_team_owner_data Data Source - oneuptime"
subcategory: ""
description: |-
  On call schedule team owner data data source
---

# oneuptime_on_call_schedule_team_owner_data (Data Source)
...
```terraform
data "oneuptime_on_call_schedule_team_owner_data" "example" {
  name = "example-on_call_schedule_team_owner_data"
}
```
