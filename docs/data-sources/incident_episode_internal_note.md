---
page_title: "oneuptime_incident_episode_internal_note Data Source - oneuptime"
subcategory: "Incidents"
description: |-
  Manage internal notes for your incident episodes
---

# oneuptime_incident_episode_internal_note (Data Source)

Manage internal notes for your incident episodes Look up by `id` or by `name` (must match exactly one item).
...
```terraform
data "oneuptime_incident_episode_internal_note" "by_name" {
  name = "example-incident_episode_internal_note"
}

data "oneuptime_incident_episode_internal_note" "by_id" {
