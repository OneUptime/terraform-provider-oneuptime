...
page_title: "oneuptime_incident_episode_user_owner_data Data Source - oneuptime"
subcategory: ""
description: |-
  Incident episode user owner data data source
---

# oneuptime_incident_episode_user_owner_data (Data Source)
...
```terraform
data "oneuptime_incident_episode_user_owner_data" "example" {
  name = "example-incident_episode_user_owner_data"
}
```
