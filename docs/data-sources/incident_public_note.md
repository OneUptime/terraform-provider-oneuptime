---
page_title: "oneuptime_incident_public_note Data Source - oneuptime"
subcategory: "Incidents"
description: |-
  Manage public notes for your incident
---

# oneuptime_incident_public_note (Data Source)

Manage public notes for your incident Look up by `id` or by `name` (must match exactly one item).
...
```terraform
data "oneuptime_incident_public_note" "by_name" {
  name = "example-incident_public_note"
}

data "oneuptime_incident_public_note" "by_id" {
