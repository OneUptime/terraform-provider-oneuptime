...
page_title: "oneuptime_podman_host_user_owner_data Data Source - oneuptime"
subcategory: ""
description: |-
  Podman host user owner data data source
---

# oneuptime_podman_host_user_owner_data (Data Source)
...
```terraform
data "oneuptime_podman_host_user_owner_data" "example" {
  name = "example-podman_host_user_owner_data"
}
```
