---
page_title: "oneuptime_alert_custom_field Data Source - oneuptime"
subcategory: "Alerts"
description: |-
  Manage custom fields for your alert.
---

# oneuptime_alert_custom_field (Data Source)

Manage custom fields for your alert. Look up by `id` or by `name` (must match exactly one item).
...
```terraform
data "oneuptime_alert_custom_field" "by_name" {
  name = "example-alert_custom_field"
}

data "oneuptime_alert_custom_field" "by_id" {
