...
- `feed_info_in_markdown` (String) Log of the entire monitor state change in Markdown. Permissions - Create: [Project Owner, Project Admin, Project Member, Create Monitor Feed], Read: [Project Owner, Project Admin, Project Member, Read Monitor Feed], Update: [No access - you don't have permission for this operation]. Computed.
...
- `monitor_feed_event_type` (String) Monitor Feed Event. Permissions - Create: [Project Owner, Project Admin, Project Member, Create Monitor Feed], Read: [Project Owner, Project Admin, Project Member, Read Monitor Feed], Update: [No access - you don't have permission for this operation]. Computed.
