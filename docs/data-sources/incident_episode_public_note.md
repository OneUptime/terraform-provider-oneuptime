...
- `should_status_page_subscribers_be_notified_on_note_created` (Bool) Should subscribers be notified about this note? If left out, this follows the episode: true when subscribers were notified that the episode was created, false when it was created without notifying them... Computed.
