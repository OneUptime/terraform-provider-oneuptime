...
page_title: "oneuptime_runbook_user_owner_data Data Source - oneuptime"
subcategory: ""
description: |-
  Runbook user owner data data source
---

# oneuptime_runbook_user_owner_data (Data Source)
...
```terraform
data "oneuptime_runbook_user_owner_data" "example" {
  name = "example-runbook_user_owner_data"
}
```
