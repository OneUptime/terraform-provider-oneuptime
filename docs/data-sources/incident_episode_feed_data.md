...
page_title: "oneuptime_incident_episode_feed_data Data Source - oneuptime"
subcategory: ""
description: |-
  Incident episode feed data data source
---

# oneuptime_incident_episode_feed_data (Data Source)
...
```terraform
data "oneuptime_incident_episode_feed_data" "example" {
  name = "example-incident_episode_feed_data"
}
```
