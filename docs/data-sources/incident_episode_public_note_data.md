...
page_title: "oneuptime_incident_episode_public_note_data Data Source - oneuptime"
subcategory: ""
description: |-
  Incident episode public note data data source
---

# oneuptime_incident_episode_public_note_data (Data Source)
...
```terraform
data "oneuptime_incident_episode_public_note_data" "example" {
  name = "example-incident_episode_public_note_data"
}
```
