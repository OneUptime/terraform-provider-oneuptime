---
page_title: "oneuptime_alert_episode_internal_note Data Source - oneuptime"
subcategory: "Alerts"
description: |-
  Manage internal notes for your alert episodes
---

# oneuptime_alert_episode_internal_note (Data Source)

Manage internal notes for your alert episodes Look up by `id` or by `name` (must match exactly one item).
...
```terraform
data "oneuptime_alert_episode_internal_note" "by_name" {
  name = "example-alert_episode_internal_note"
}

data "oneuptime_alert_episode_internal_note" "by_id" {
