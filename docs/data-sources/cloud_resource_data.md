...
page_title: "oneuptime_cloud_resource_data Data Source - oneuptime"
subcategory: ""
description: |-
  Cloud resource data data source
---

# oneuptime_cloud_resource_data (Data Source)
...
```terraform
data "oneuptime_cloud_resource_data" "example" {
  name = "example-cloud_resource_data"
}
```
