---
page_title: "oneuptime_monitor_custom_field Data Source - oneuptime"
subcategory: "Monitors"
description: |-
  Manage custom fields for your monitor
---

# oneuptime_monitor_custom_field (Data Source)

Manage custom fields for your monitor Look up by `id` or by `name` (must match exactly one item).
...
```terraform
data "oneuptime_monitor_custom_field" "by_name" {
  name = "example-monitor_custom_field"
}

data "oneuptime_monitor_custom_field" "by_id" {
