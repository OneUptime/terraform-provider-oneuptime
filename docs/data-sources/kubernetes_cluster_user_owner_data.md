...
page_title: "oneuptime_kubernetes_cluster_user_owner_data Data Source - oneuptime"
subcategory: ""
description: |-
  Kubernetes cluster user owner data data source
---

# oneuptime_kubernetes_cluster_user_owner_data (Data Source)
...
```terraform
data "oneuptime_kubernetes_cluster_user_owner_data" "example" {
  name = "example-kubernetes_cluster_user_owner_data"
}
```
